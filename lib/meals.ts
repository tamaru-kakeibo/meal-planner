...
export interface Meal {
  ...
  steps: string[];           // 作り方（{{食材名}}で人数スケール対応）
  tip?: string;
...
export const MEALS: Record<string, Meal> = {
  ...
  f2: {
    ...
    steps: [
      ...
      '鍋に水{{水}}・酒{{酒}}・砂糖{{砂糖}}・みりん{{みりん}}・醤油{{醤油}}・しょうがを入れて煮立てる',
      '味噌{{味噌}}を溶かし入れてさばを加え、落し蓋をして弱中火で15分煮る',
    ],
  ...
  f3: {
    ...
    steps: [
      'ぶりを醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}に10分漬ける',
  ...
  f5: {
    ...
    steps: [
      '鍋に水{{水}}・醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}・しょうがを入れて煮立てる',
  ...
  c1: {
    ...
    steps: [
      '鶏肉を醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}に10分漬ける',
      'フライパンで皮目から中火で7分焼く',
  ...
  c2: {
    ...
    steps: [
      ...
      '鍋にだし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}を入れて煮立て、鶏肉と玉ねぎを加えて中火で5分煮る',
  ...
  c3: {
    ...
    steps: [
      ...
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}を加えて15分煮る',
    ],
  ...
  c5: {
    ...
    steps: [
      '鶏肉に塩こしょうをして30分常温に戻す',
      'にんにくを潰して油で炒め香りを出す',
      '鶏肉を皮目から入れ蓋をせず中火でカリッと7分・裏返して5分焼き、仕上げに醤油{{醤油}}を回しかける',
    ],
  ...
  c7: {
    ...
    steps: [
      '鶏肉を一口大に切り、醤油{{醤油}}・酒{{酒}}・ごま油{{ごま油}}・にんにく&しょうがすりおろしをもみ込んで15分漬ける',
      '片栗粉{{片栗粉}}をまぶして170℃の油で4〜5分揚げる',
  ...
  p1: {
    ...
    steps: [
      '玉ねぎを薄切り、しょうがをすりおろす',
      '醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}・しょうがを合わせてタレを作る',
  ...
  p2: {
    ...
    steps: [
      '野菜を食べやすい大きさに切る',
      '味噌{{味噌}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}を合わせてタレを作る',
  ...
  p3: {
    ...
    steps: [
      ...
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}・酒{{酒}}を加えて落し蓋をし弱中火で20分煮る',
    ],
  ...
  p4: {
    ...
    steps: [
      ...
      'ごま油{{ごま油}}で豚肉と野菜を炒める',
      '水{{水}}とだし{{だし}}を加えて野菜がやわらかくなるまで10分煮て、味噌{{味噌}}を溶かし入れる',
    ],
  ...
  p5: {
    ...
    steps: [
      ...
      '野菜を加えて炒め、味噌{{味噌}}・醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}を合わせたタレで炒め合わせる',
    ],
  ...
  p6: {
    ...
    steps: [
      '玉ねぎを薄切りにする',
      'ごま油{{ごま油}}で豚肉を炒め、玉ねぎ・もやしを加えてしんなりするまで炒める',
      '全体に火が通ったらポン酢{{ポン酢}}を回しかけ、手早く炒め合わせる',
    ],
  ...
  b1: {
    ...
    steps: [
      '玉ねぎを薄切りにする',
      '鍋にだし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}・酒{{酒}}を入れて煮立て、玉ねぎを加えて5分煮る',
  ...
  e1: {
    ...
    steps: [
      ...
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・豆板醤を加えて煮立てる',
      '木綿豆腐を加えて5分煮て、水溶き片栗粉（片栗粉{{片栗粉}}＋水大さじ2）でとろみをつけ、ねぎをちらす',
    ],
  ...
  e2: {
    ...
    steps: [
      ...
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・酒{{酒}}・砂糖{{砂糖}}を合わせて煮立てる',
  ...
  e3: {
    ...
    steps: [
      'バター{{バター}}で鶏肉と玉ねぎを炒め、ケチャップ{{ケチャップ}}・塩こしょうでケチャップライスを作る',
      '溶き卵2個（1人分）を薄く焼く',
  ...
  o1: {
    ...
    steps: [
      '玉ねぎをみじん切りにして炒めて冷ます',
      'ひき肉・卵・パン粉{{パン粉}}・牛乳{{牛乳}}・塩こしょう・炒め玉ねぎをよくこねる',
  ...
  o2: {
    ...
    steps: [
      ...
      'ひき肉・豆腐・玉ねぎ（みじん切り）・卵・パン粉{{パン粉}}・塩こしょうをよくこねる',
      '成形して中火で両面焼き→蒸し焼き5分・醤油{{醤油}}とみりん{{みりん}}を合わせたタレをかける',
    ],
  ...
  o5: {
    ...
    steps: [
      ...
      'ひき肉・にんじんを加えて炒め、カレー粉{{カレー粉}}・ケチャップ{{ケチャップ}}・ウスターソース{{ウスターソース}}・塩こしょうで味付けし水分が飛ぶまで炒める',
    ],
  ...
  o6: {
    ...
    steps: [
      ...
      'トマト缶・コンソメ{{コンソメ}}・ケチャップ{{ケチャップ}}・ウスターソース{{ウスターソース}}を加えて弱火で15分煮込み、塩こしょうで調整する',
...
export const SIDES: Record<string, Side> = {
  s1: {
    ...
    steps: [
      'ほうれん草を塩少量を入れた湯で1〜2分茹でて冷水にとる',
      '水気をしっかり絞って3cm幅に切る',
      '醤油{{醤油}}・だし{{だし}}をかけて白ごまを振る',
    ],
  },
  s2: {
  ...
  s3: {
    ...
    steps: [
      'ごぼうとにんじんを細切りにし、ごぼうは水にさらしてアク抜きする',
      'ごま油{{ごま油}}で炒める',
      '醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}で味付けして白ごまを振る',
    ],
  },
  s4: {
    ...
    steps: [
      'ひじきを水で20分戻してザルにあける',
      'にんじん・油揚げと一緒にごま油で炒める',
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}・酒{{酒}}で汁気がなくなるまで煮含める',
    ],
  },
  s5: {
    ...
    steps: [
      'かぼちゃを3〜4cm角に切る（皮の面が鍋底になるよう並べると煮崩れしにくい）',
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}を合わせて煮立てる',
      '落し蓋をして弱中火で15分、やわらかくなるまで煮る',
    ],
  },
  s6: {
    ...
    steps: [
      '小松菜を根元から3cm幅に切る',
      'ごま油{{ごま油}}で茎から先に炒め、葉を加える',
      '醤油{{醤油}}・酒{{酒}}で味付けして白ごまを振る',
    ],
  },
  s7: {
    ...
    steps: [
      'もやしをさっと30秒茹でてザルにあけ、水気をしっかり絞る',
      'ごま油{{ごま油}}・醤油{{醤油}}・塩少量で和える',
      '白ごまを振る',
    ],
  },
  s8: {
    ...
    steps: [
      '大根を2cm幅の半月切りにして下茹で（5分）する',
      'ひき肉をごま油で炒めてほぐし、大根を加える',
      'だし{{だし}}・醤油{{醤油}}・みりん{{みりん}}・砂糖{{砂糖}}で10分煮る',
    ],
  },
  s9: {
  ...
  s10: {
    ...
    steps: [
      '卵{{卵}}・だし{{だし}}・醤油{{醤油}}・砂糖{{砂糖}}をよく混ぜる',
      '卵焼き器に薄く油を引き、卵液を3回に分けて入れて巻く',
      '冷ましてから食べやすく切る',
    ],
  },
};
...
export const SOUPS: Record<string, Soup> = {
  sp1: {
    ...
    steps: [
      '水{{水}}にだし{{だし}}を溶かして鍋で沸かす',
      '絹豆腐を1cm角に切って加え、水で戻したわかめも入れる',
      '火を弱めて味噌{{味噌}}を溶かし入れ、沸騰直前で火を止める',
    ],
  },
  sp2: {
  ...
  sp3: {
    ...
    steps: [
      '水{{水}}にだし{{だし}}を溶かして煮立て、醤油{{醤油}}・塩少量で味を整える',
  ...
  sp4: {
    ...
    steps: [
      'コーン缶の汁ごと水{{水}}とともにミキサーにかけてなめらかにする',
      '鍋に移して牛乳{{牛乳}}・コンソメ{{コンソメ}}を加えて中火で温める',
      '沸騰直前に塩こしょうで味を整える',
    ],
  },
  sp5: {
